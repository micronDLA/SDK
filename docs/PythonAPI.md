...
***Return value:*** None. <span style="color:red">FIXME FIXME FIXME ????????? .</span>
...
***Return value:***: recover the parameters set for a previously given input <span style="color:red">FIXME FIXME FIXME.</span>
