...
def main():
    ...
    if args.model == 'linknet':
        ...
        yolov3 = YOLOv3(input_img[np.newaxis], args.model_path, 1, True)
        ...
        yolov3 = YOLOv3Tiny(input_img[np.newaxis], args.model_path, 1, True)
        model_output = yolov3(input_img[np.newaxis])
        ...
        # Instantiate model
        retinanet = RetinaNetDLA(args.model_path, 'RetinaNet/labels.txt', [640, 384, 3], numclus=1, threshold=0.5, disp_time=0)
