...
def main():
    ...
    if args.model == 'superresolution':
        ...
        yolov3 = YOLOv3(input_array, args.model_path, args.numfpga, False)
        ...
        input_array = np.random.rand(args.numfpga, 3, 416, 416)
        yolov3 = YOLOv3Tiny(input_array, args.model_path, args.numfpga, False)
        model_output = yolov3(input_array)
        del yolov3
        ...
        input_array = np.random.rand(2, 299, 299, 3)
        inception = InceptionDLA(input_array, args.model_path, args.numfpga, args.numclus)
