...
static const char *microndla_version = "2020.2.3";
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
This runs the model in software using the same data precision of the accelerator
    ...
    @return -1 (error), 0 (pass)
*/
int IECOMPILER_API ie_run_sim(void *cmemo, const float * const *input, const uint64_t *input_elements, unsigned ninputs, float **output, uint64_t *output_elements, unsigned noutputs);
...
args:
    ...
    @return -1 (error), 0 (pass)
*/
int IECOMPILER_API thnets_run_sim(void *cmemo, const float * const *input, const uint64_t *input_elements, unsigned ninputs, float **output, uint64_t *output_elements, unsigned noutputs);
